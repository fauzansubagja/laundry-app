<form>
    <div class="row">
        <div class="mb-3 col-md-12">
            ...
            <input type="text" name="name" id="name" value="{{ $pakets->name }}" class="form-control"
                placeholder="Nama">
        </div>
        <div class="mb-3 col-md-12">
            <label class="form-label">Email</label>
            <input type="text" name="email" id="email" value="{{ $pakets->email }}" class="form-control"
                placeholder="Email">
        </div>
        <div class="mb-3 col-md-12">
        ...
        <div class="mb-3 col-md-12">
            ...
            <select class="default-select  form-control wide" name="role" id="role" value="{{ $pakets->role }}">
