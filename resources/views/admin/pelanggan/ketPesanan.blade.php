...
<div class="modal-body">
    <div class="default-tab">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#keterangan"><i
                        class="la la-exclamation-circle me-2"></i>
                    Keterangan</a>
            </li>
        </ul>
                            ...
                            <tbody>
                                ...
                                @foreach ($detailTransaksi as $detail)
                                    <tr>
                                        ...
                                        <td class="center">Rp. {{ number_format($detail->paket->harga, 0, ',', '.') }}
                                        </td>
                                    </tr>
                                    @php
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right"><strong>Rp.
                                                {{ number_format($totalSetelahDiskon, 0, ',', '.') }}</strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
